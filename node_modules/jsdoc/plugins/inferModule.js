...
exports.astNodeVisitor = {
    visitNode: function(node, e, parser, currentSourceName, is_test) {

        // Define is_test to pull from test conf.json, if running test suite.
        is_test = typeof is_test !== 'undefined' ? is_test : false;
        ...
        if (node.comments != undefined) {
            ...
            // value in conf.
            if ((conf = JSON.parse(conf)).inferModule == undefined) {
                throw new Error('No "inferModule" key is defined in conf.json.');
            }
            ...
            conf.inferModule.map(function(item) {
